...
//
//  Ported to goouts_app 22 August 2026. Originally written for goouts_host,
//  reported as "in host registration selfie
...
//  driver who cannot finish verifying because re-encoding threw.
//
//  ⚠ IDENTICAL COPY. goouts_app, goouts_host and driver_app each hold their own — these
//  are separate apps with no shared package between them. If this file is
//  changed in one, change it in the other, or the two will drift the way
//  everything duplicated in this codebase eventually has.
// ─────────────────────────────────────────────────────────────────────────────
...
Future<String> normaliseOrientation(String path) async {
  try {
    ...
    // See the header: a possibly-sideways photograph beats a person who
