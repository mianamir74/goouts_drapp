  ...
  Widget _adminNote() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFB3DFF5)),
      ),
      child: const Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Icon(Icons.info_outline_rounded, size: 16, color: _goOutsBlue),
          SizedBox(width: 8),
          Expanded(
            child: Text(
              'These Terms & Conditions will be manageable from the '
              'GoOuts Admin Panel in a future update.',
              style: TextStyle(
                fontSize: 12,
