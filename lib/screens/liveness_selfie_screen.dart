        ...
        Expanded(
          child: Stack(
            ...
            children: <Widget>[
              ...
              // ── ⚠ A VIGNETTE, NOT A CIRCULAR CUTOUT ─────────────────────
              //
              // Added 25 August 2026. The whole camera feed was visible edge to
              // edge, so the room competed with the face and the ring had to
              // fight a busy background.
              //
              // A hard-edged spotlight looks stronger but has to sit exactly
              // over the ring, which is not exactly centred — it shares a
              // column with the direction arrows. A gradient has no boundary to
              // misalign, and this file runs in three apps on phone sizes
              // nobody here owns.
              //
              // ⚠ PAINT, NOT EXPOSURE. Drawn over the preview, so ML Kit still
              // gets the original frames and the brightness and glare checks
              // are unaffected.
              ...
              Positioned(
                ...
                child: ValueListenableBuilder<LivenessRingState>(
                  ...
                  builder: (_, LivenessRingState st, Widget? child) {
                    ...
                    // ⚠ GLASSES ARE STOPPED BEFORE THE SWEEP, NOT AFTER THE
                    // PHOTOGRAPH. The glare check ran on the finished picture,
                    // so somebody turned their head, held still, had their
                    // photo taken, and was THEN told to remove their glasses
                    // and do it all again. Right check, cruel timing.
                    return ValueListenableBuilder<bool>(
                      valueListenable: auto.glare,
                          ...
                          return Container(
                            ...
                            child: const Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Text(
                                    'Please take your glasses off — the lenses '
                                    'are hiding your eyes.',
                                    style: TextStyle(
                                        fontSize: 13,
                                        height: 1.4,
